...
@Component({
  selector: 'app-home', // Defines the selector used to identify this component in a template
  template: `
    <div class="home-container">
      <img src="/assets/rpg-banner.jpg" alt="RPG Banner Image" class="banner-image">
      <h1>Welcome to Mythical Haven</h1> <!-- Main header for the home page -->

      <!-- Introduction paragraph about the platform -->
      ...
      <!-- Detailed paragraph about character customization features -->
      ...
      <!-- Additional paragraph on character development -->
      ...
      <!-- Paragraph about campaign management tools -->
      ...
      <!-- Invitation to join the RPG community -->
      ...
      <!-- Final paragraph emphasizing community and creativity -->
